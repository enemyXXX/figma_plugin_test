...
export interface ModalCardProps extends NavIdProps, Omit<ModalCardBaseProps, 'id' | 'onClose' | 'onTransitionEnd' | keyof UseBottomSheetHandlers>, Pick<UseFocusTrapProps, 'restoreFocus'> {
    /**
     * Состояние видимости.
     *
     * @default false
